...
{
    float location_x;                // 0x0000 (size: 0x8)
    float location_y;                // 0x0008 (size: 0x8)
    float location_z;                // 0x0010 (size: 0x8)
    float rotation_x;                // 0x0018 (size: 0x8)
    float rotation_y;                // 0x0020 (size: 0x8)
    float rotation_z;                // 0x0028 (size: 0x8)
